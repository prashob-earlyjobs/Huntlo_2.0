...
export function TalentOperationsEnterprise() {
  return (
...
export function TalentOperationsFuture() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
            Recruitment operations became software.
          </h2>
          <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
            Hiring operations are becoming intelligence. The organizations that define the next
            decade won&apos;t scale recruitment processes, hiring operations, or operational
            complexity.
          </p>
        </div>
        ...
        <p className="mt-10 text-xl font-semibold text-[#141b2b] md:text-2xl">
          Welcome to the future of enterprise hiring.
        </p>
      </div>
    </section>
  );
...
export function TalentOperationsFaq() {
  return (
    <section className="bg-[#f7f8fc] px-4 py-20 md:px-8 md:py-28 lg:px-12" id="faqs">
      <div className="mx-auto max-w-3xl">
        ...
        <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
          Questions about Hiring Operations Intelligence™
        </h2>
        <p className="mt-4 text-base leading-relaxed text-[#434654] md:text-lg">
          Clear answers for enterprises evaluating Hiring Operations Intelligence™ — not another
          recruitment ops tool.
        </p>

        <div className="mt-10 space-y-3">
          {TALENT_OPERATIONS_FAQS.map((item) => (
            <details
              key={item.question}
...
export function TalentOperationsFinalCta() {
  return (
    <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        <h2 className="text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
          Great organizations scale hiring intelligence.
        </h2>
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/65 md:text-lg">
          Discover how Huntlo is building Hiring Operations Intelligence™ for the future of Human +
          AI Hiring.
        </p>
