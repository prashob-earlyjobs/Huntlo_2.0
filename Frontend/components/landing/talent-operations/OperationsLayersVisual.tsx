...
import { HERO_FLOW } from "@/lib/talentOperations";

type OperationsLayersVisualProps = {
  reduceMotion: boolean;
};

export function OperationsLayersVisual({ reduceMotion }: OperationsLayersVisualProps) {
