...
type TalentOperationsSystemsProps = {
  reduceMotion: boolean;
};

export function TalentOperationsSystems({ reduceMotion }: TalentOperationsSystemsProps) {
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Great hiring operations never stop learning.
            </h2>
          </div>
      ...
      <section className="bg-[#f1f3ff] px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Hiring intelligence creates better operations.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
              Everything continuously improving. Modern enterprises won&apos;t optimize recruitment
              operations. They&apos;ll optimize hiring outcomes.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
              AI amplifies enterprise hiring.
              <span className="mt-2 block text-white/70">Not enterprise operations.</span>
            </h2>
          </div>
      ...
      <section className="border-b border-[#c3c6d6]/30 bg-white px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Hiring operations are becoming infrastructure.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
              Future organizations won&apos;t ask which recruitment operations software to purchase.
              They&apos;ll ask how intelligently hiring can continuously improve itself.
            </p>
          </div>
          ...
          <ul className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {INFRA_CHANGES.map((item) => (
              <li
                key={item}
                className="rounded-2xl border border-[#c3c6d6]/35 bg-[#f7f8fc] px-5 py-4 text-sm font-semibold text-[#141b2b]"
              >
                {item}
              </li>
            ))}
      ...
      <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#8eb0ff]">
              Future enterprise hiring stack
            </p>
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
              From recruitment operations to Hiring Operations Intelligence™.
            </h2>
          </div>
      ...
      <section className="bg-[#f1f3ff] px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Hiring intelligence creates enterprise outcomes.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
              Organizations that define the next decade won&apos;t optimize recruiting processes,
              hiring operations, or workflow automation.
            </p>
          </div>
