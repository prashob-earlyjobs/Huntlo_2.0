...
type AiSourcingAgentSystemsProps = {
  reduceMotion: boolean;
};

export function AiSourcingAgentSystems({ reduceMotion }: AiSourcingAgentSystemsProps) {
  return (
    <>
      ...
      <section className="bg-[#f1f3ff] px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              AI Talent Discovery Creates Better Outcomes.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
              ...
              candidate searches. They should optimize talent intelligence.
            </p>
          </div>
      ...
      <section className="border-b border-[#c3c6d6]/30 bg-white px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              From AI search to AI Talent Discovery Agents™.
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
              ...
              <span className="mt-2 block text-white/70">Not recruiter replacement.</span>
            </h2>
            <p className="mt-5 text-base leading-relaxed text-white/65 md:text-lg">
              Future recruiting won&apos;t choose humans or artificial intelligence. It will choose
              Human + AI Hiring™.
            </p>
          </div>
