...
import { HERO_FLOW } from "@/lib/candidateEngagement";

type ConversationFlowVisualProps = {
  reduceMotion: boolean;
};

export function ConversationFlowVisual({ reduceMotion }: ConversationFlowVisualProps) {
          ...
          {steps.map((step, index) => (
            <motion.li
              ...
              className={`flex items-center gap-3 rounded-2xl border px-3.5 py-2.5 ${
                step === "Relationship Intelligence"
