...
export function CandidateEngagementEnterprise() {
  return (
...
export function CandidateEngagementFuture() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
            Great hiring isn&apos;t transactional.
          </h2>
          <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
            It&apos;s relational. The organizations that define the next decade won&apos;t optimize
            engagement campaigns, nurture workflows, or follow-up sequences.
          </p>
        </div>
        ...
        <p className="mt-10 text-xl font-semibold text-[#141b2b] md:text-2xl">
          Welcome to the future of candidate relationships.
        </p>
      </div>
    </section>
  );
...
export function CandidateEngagementFaq() {
  return (
    <section className="bg-[#f7f8fc] px-4 py-20 md:px-8 md:py-28 lg:px-12" id="faqs">
      <div className="mx-auto max-w-3xl">
        ...
        <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
          Questions about Candidate Relationship Intelligence™
        </h2>
        <p className="mt-4 text-base leading-relaxed text-[#434654] md:text-lg">
          Clear answers for teams evaluating Candidate Relationship Intelligence™ — not another
          engagement or nurture tool.
        </p>

        <div className="mt-10 space-y-3">
          {CANDIDATE_ENGAGEMENT_FAQS.map((item) => (
            <details
              key={item.question}
...
export function CandidateEngagementFinalCta() {
  return (
    <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        <h2 className="text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
          Great hiring builds great relationships.
        </h2>
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/65 md:text-lg">
          Discover how Huntlo is building Candidate Relationship Intelligence™ for the future of
          Human + AI Hiring.
        </p>
