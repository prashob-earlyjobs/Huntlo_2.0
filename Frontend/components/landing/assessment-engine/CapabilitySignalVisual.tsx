...
import { HERO_FLOW } from "@/lib/assessmentEngine";

type CapabilitySignalVisualProps = {
  reduceMotion: boolean;
};

export function CapabilitySignalVisual({ reduceMotion }: CapabilitySignalVisualProps) {
