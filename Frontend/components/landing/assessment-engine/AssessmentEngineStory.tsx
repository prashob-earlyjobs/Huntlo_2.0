...
import {
  CAPABILITY_UNDERSTANDS,
  MODERN_UNDERSTANDS,
  TRADITIONAL_MEASURES,
} from "@/lib/assessmentEngine";

type AssessmentEngineStoryProps = {
  reduceMotion: boolean;
};

export function AssessmentEngineStory({ reduceMotion }: AssessmentEngineStoryProps) {
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Great hiring requires more than assessments.
            </h2>
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border border-[#c3c6d6]/35 bg-[#f7f8fc] p-6">
              ...
              <ol className="mt-5 space-y-2">
                {TRADITIONAL_MEASURES.map((item, index) => (
                  <li
                    key={item}
            ...
            <div className="rounded-2xl border border-[#0050cb]/25 bg-[#0050cb]/8 p-6">
              <h3 className="text-sm font-semibold uppercase tracking-[0.16em] text-[#0050cb]">
                Modern hiring continuously understands
              </h3>
              <ol className="mt-5 space-y-2">
                {MODERN_UNDERSTANDS.map((item, index) => (
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-base leading-relaxed text-white/65 md:text-lg">
              Continuously understanding capability — before organizations ever make hiring
              decisions.
            </p>
          </div>

          <ul className="mt-10 space-y-3">
            {CAPABILITY_UNDERSTANDS.map((item, index) => (
              <motion.li
                key={item}
          ...
          <p className="mt-10 max-w-2xl text-base leading-relaxed text-white/70 md:text-lg">
            ...
            which candidate creates the greatest long-term business impact.
          </p>
        </div>
      </section>
    </>
