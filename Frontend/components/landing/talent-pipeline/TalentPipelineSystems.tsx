...
type TalentPipelineSystemsProps = {
  reduceMotion: boolean;
};

export function TalentPipelineSystems({ reduceMotion }: TalentPipelineSystemsProps) {
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Great talent discovery creates great relationships.
            </h2>
          </div>
      ...
      <section className="bg-[#f1f3ff] px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Talent networks never stop learning.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
              Everything continuously improving. Modern organizations shouldn&apos;t ask which
              candidates are in their pipeline. They should ask which talent relationships matter
              most right now.
            </p>
          </div>
          ...
          <ul className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {LEARNING_CHANGES.map((item) => (
              <li
                key={item}
                className="rounded-2xl border border-[#0050cb]/20 bg-white px-5 py-4 text-sm font-semibold text-[#141b2b]"
              >
                {item}
              </li>
            ))}
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
              AI amplifies talent understanding.
              <span className="mt-2 block text-white/70">Not talent management.</span>
            </h2>
          </div>
      ...
      <section className="border-b border-[#c3c6d6]/30 bg-white px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Talent relationships are becoming infrastructure.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
              Future enterprises won&apos;t ask which Talent CRM they should use. They&apos;ll ask
              how intelligently they can continuously understand talent relationships.
            </p>
            <p className="mt-6 text-base font-semibold text-[#141b2b] md:text-lg">
              Everything changes when hiring becomes relationship driven.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#8eb0ff]">
              From pipelines to networks
            </p>
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
              Talent pipelines are becoming intelligence networks.
            </h2>
          </div>
