...
export function GccSourcingAutomationEnterprise() {
  return (
    <GccSection className="border-b border-[#c3c6d6]/25 bg-white">
      <div className="grid gap-10 lg:grid-cols-[1fr_1.2fr] lg:items-end">
        <div>
          ...
          <GccLead>
            Authentication, permissions, compliance, and infrastructure options for enterprise GCC
            hiring.
          </GccLead>
        </div>
        <div>
...
export function GccSourcingAutomationIndustries() {
  return (
...
export function GccSourcingAutomationFaq() {
  return (
    <GccSection className="bg-white" id="faqs">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-2">
          {GCC_SOURCING_AUTOMATION_FAQS.map((item) => (
...
export function GccSourcingAutomationFinalCta() {
  return (
    <section className="bg-[#050914] px-4 py-20 text-white md:px-8 md:py-24 lg:px-12">
      <div className="mx-auto max-w-3xl text-center">
        <h2 className="text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.35rem]">
          The future of candidate sourcing isn&apos;t more searching.
          <span className="mt-2 block text-white/70">It&apos;s better intelligence.</span>
        </h2>
        <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-white/60">
          Discover qualified candidates faster. Reduce recruiter workload. Build stronger hiring
          pipelines.
        </p>
        <div className="mt-9 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
          ...
          <Link href="/gcc-talent-intelligence" className={ghostCtaClass}>
            Talent Intelligence
          </Link>
        </div>
      </div>
