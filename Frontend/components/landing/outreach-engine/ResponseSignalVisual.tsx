...
import { HERO_FLOW } from "@/lib/outreachEngine";

type ResponseSignalVisualProps = {
  reduceMotion: boolean;
};

export function ResponseSignalVisual({ reduceMotion }: ResponseSignalVisualProps) {
          ...
          {steps.map((step, index) => (
            <motion.li
              ...
              className={`flex items-center gap-3 rounded-2xl border px-3.5 py-2.5 ${
                step === "Conversation Intelligence"
