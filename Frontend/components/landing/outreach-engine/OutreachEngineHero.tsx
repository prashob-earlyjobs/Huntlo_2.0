...
import { ResponseSignalVisual } from "./ResponseSignalVisual";

type OutreachEngineHeroProps = {
  reduceMotion: boolean;
};

export function OutreachEngineHero({ reduceMotion }: OutreachEngineHeroProps) {
  return (
      ...
      <div className="relative mx-auto grid max-w-6xl gap-14 px-4 py-20 md:px-8 md:py-28 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:gap-16 lg:px-12 lg:py-36">
        ...
        >
          ...
          <h1 className="mt-5 max-w-xl text-[2rem] font-bold leading-[1.1] tracking-tight sm:text-[2.45rem] md:text-[3.1rem] lg:text-[3.3rem]">
            Candidates don&apos;t respond to outreach.
            <span className="mt-2 block text-white/75">
              They respond to great conversations.
            </span>
          </h1>
          <p className="mt-6 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
            Modern hiring isn&apos;t limited by candidate availability. It&apos;s limited by how
            intelligently organizations begin and maintain candidate conversations.
          </p>
          <p className="mt-4 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
            Great hiring doesn&apos;t optimize emails sent, WhatsApp campaigns, or outreach volume.
            It optimizes conversations, candidate experiences, hiring momentum, and hiring outcomes.
          </p>
          <p className="mt-8 text-lg font-semibold tracking-tight md:text-xl">
            Welcome to Conversation Intelligence™.
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            ...
            <Link href="#conversation-intelligence" className={secondaryCtaClass}>
        ...
        >
          <ResponseSignalVisual reduceMotion={reduceMotion} />
        </motion.div>
      </div>
    </section>
  );
