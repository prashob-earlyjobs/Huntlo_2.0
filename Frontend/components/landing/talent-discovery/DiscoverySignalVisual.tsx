...
import { HERO_FLOW } from "@/lib/talentDiscovery";

type DiscoverySignalVisualProps = {
  reduceMotion: boolean;
};

export function DiscoverySignalVisual({ reduceMotion }: DiscoverySignalVisualProps) {
