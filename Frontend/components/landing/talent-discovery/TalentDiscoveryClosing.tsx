...
export function TalentDiscoveryEnterprise() {
  return (
...
export function TalentDiscoveryFuture() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
            Talent discovery isn&apos;t becoming faster.
          </h2>
          <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
            It&apos;s becoming more intelligent. The next generation of organizations won&apos;t
            optimize candidate searches, sourcing workflows, or recruitment databases.
          </p>
        </div>
...
export function TalentDiscoveryFaq() {
  return (
    <section className="bg-[#f7f8fc] px-4 py-20 md:px-8 md:py-28 lg:px-12" id="faqs">
      <div className="mx-auto max-w-3xl">
        ...
        <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
          Questions about Talent Discovery Intelligence™
        </h2>
        <p className="mt-4 text-base leading-relaxed text-[#434654] md:text-lg">
          Clear answers for teams evaluating talent discovery — not another search or database
          tool.
        </p>

        <div className="mt-10 space-y-3">
          {TALENT_DISCOVERY_FAQS.map((item) => (
            <details
              key={item.question}
...
export function TalentDiscoveryFinalCta() {
  return (
    <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/65 md:text-lg">
          Discover how Huntlo is building Talent Discovery Intelligence™ for the future of Human +
          AI Hiring.
        </p>
