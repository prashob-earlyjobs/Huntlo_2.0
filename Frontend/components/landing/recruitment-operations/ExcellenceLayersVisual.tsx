...
import { HERO_FLOW } from "@/lib/recruitmentOperations";

type ExcellenceLayersVisualProps = {
  reduceMotion: boolean;
};

export function ExcellenceLayersVisual({ reduceMotion }: ExcellenceLayersVisualProps) {
