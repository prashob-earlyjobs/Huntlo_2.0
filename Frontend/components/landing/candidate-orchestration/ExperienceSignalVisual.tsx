...
import { HERO_FLOW } from "@/lib/candidateOrchestration";

type ExperienceSignalVisualProps = {
  reduceMotion: boolean;
};

export function ExperienceSignalVisual({ reduceMotion }: ExperienceSignalVisualProps) {
