...
import { HERO_FLOW } from "@/lib/whatsappRecruiting";

type ConversationSignalVisualProps = {
  reduceMotion: boolean;
};

export function ConversationSignalVisual({ reduceMotion }: ConversationSignalVisualProps) {
