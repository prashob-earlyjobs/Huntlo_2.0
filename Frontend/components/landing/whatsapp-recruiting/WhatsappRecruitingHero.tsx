...
import { ConversationSignalVisual } from "./ConversationSignalVisual";
import { ghostCtaClass, primaryCtaClass, secondaryCtaClass } from "./ctaClasses";

type WhatsappRecruitingHeroProps = {
  reduceMotion: boolean;
};

export function WhatsappRecruitingHero({ reduceMotion }: WhatsappRecruitingHeroProps) {
  return (
      ...
      <div className="relative mx-auto grid max-w-6xl gap-14 px-4 py-20 md:px-8 md:py-28 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:gap-16 lg:px-12 lg:py-36">
        ...
        >
          ...
          <h1 className="mt-5 max-w-xl text-[2rem] font-bold leading-[1.1] tracking-tight sm:text-[2.45rem] md:text-[3.1rem] lg:text-[3.3rem]">
            Great Hiring Doesn&apos;t Wait.
            <span className="mt-2 block text-white/75">It Happens In Real Time.</span>
          </h1>
          <p className="mt-6 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
            Exceptional candidates don&apos;t wait days for conversations to begin. They expect
            hiring experiences that are immediate, contextual, conversational, and meaningful.
          </p>
          <p className="mt-4 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
            Modern organizations don&apos;t lose talent because they lack messaging platforms. They
            lose talent because hiring momentum breaks between conversations.
          </p>
          <p className="mt-8 text-lg font-semibold tracking-tight md:text-xl">
            Welcome To Real-Time Hiring Intelligence™.
        ...
        >
          <ConversationSignalVisual reduceMotion={reduceMotion} />
        </motion.div>
      </div>
    </section>
  );
