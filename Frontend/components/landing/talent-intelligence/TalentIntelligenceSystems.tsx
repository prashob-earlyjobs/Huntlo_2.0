...
type TalentIntelligenceSystemsProps = {
  reduceMotion: boolean;
};

export function TalentIntelligenceSystems({ reduceMotion }: TalentIntelligenceSystemsProps) {
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Talent Intelligence never stops learning.
            </h2>
          </div>
      ...
      <section className="bg-[#f1f3ff] px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Intelligence creates better hiring decisions.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
              ...
              databases. They should optimize Talent Intelligence™.
            </p>
          </div>

          <ol className="mt-10 space-y-3">
            {DECISION_LOOP.map((item, index) => (
              <motion.li
                key={item}
      ...
      <section className="border-b border-[#c3c6d6]/30 bg-white px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              From talent databases to Talent Intelligence™.
            </h2>
          </div>
      ...
      <section className="bg-[#f1f3ff] px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Talent Intelligence creates enterprise outcomes.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
              Future organizations will optimize continuously — everything begins with Talent
              Intelligence™.
            </p>
          </div>
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
              Talent Intelligence is becoming infrastructure.
            </h2>
          </div>
