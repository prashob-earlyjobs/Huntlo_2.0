...
import { FULL_WORKFLOW } from "@/lib/hiringOs";

type HiringOsWorkflowProps = {
  reduceMotion: boolean;
};

export function HiringOsWorkflow({ reduceMotion }: HiringOsWorkflowProps) {
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
            One hiring workflow. Endless possibilities.
          </h2>
          <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
            From requirement to hire, Huntlo is designed so the operating system carries the
            connected steps — while recruiters stay focused on decisions.
          </p>
        </div>
