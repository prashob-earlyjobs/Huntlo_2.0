...
type CandidateIntelligenceStoryProps = {
  reduceMotion: boolean;
};

export function CandidateIntelligenceStory({
  reduceMotion,
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#0050cb]">
              Beyond candidate data
            </p>
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Great hiring requires more than candidate data.
            </h2>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
              Introducing Candidate Intelligence™
            </h2>
            <p className="mt-5 text-base leading-relaxed text-white/65 md:text-lg">
              Continuously understanding talent — before recruiters ever begin conversations.
            </p>
          </div>
          ...
          <p className="mt-10 max-w-2xl text-base leading-relaxed text-white/70 md:text-lg">
            Future organizations won&apos;t ask which candidate they should hire. They&apos;ll ask
