...
export function CandidateIntelligenceEnterprise() {
  return (
...
export function CandidateIntelligenceFuture() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
            Great hiring doesn&apos;t begin with resumes.
          </h2>
          <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
            It begins with understanding people. The next generation of organizations won&apos;t
            optimize candidate profiles, recruitment databases, or hiring processes.
          </p>
        </div>
        ...
        <p className="mt-10 text-xl font-semibold text-[#141b2b] md:text-2xl">
          Welcome to the future of Candidate Intelligence.
        </p>
      </div>
    </section>
  );
...
export function CandidateIntelligenceFaq() {
  return (
    <section className="bg-[#f7f8fc] px-4 py-20 md:px-8 md:py-28 lg:px-12" id="faqs">
      <div className="mx-auto max-w-3xl">
        ...
        <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
          Questions about Candidate Intelligence™
        </h2>
        <p className="mt-4 text-base leading-relaxed text-[#434654] md:text-lg">
          Clear answers for teams evaluating Candidate Intelligence™ — not another profile or
          enrichment tool.
        </p>

        <div className="mt-10 space-y-3">
          {CANDIDATE_INTELLIGENCE_FAQS.map((item) => (
            <details
              key={item.question}
...
export function CandidateIntelligenceFinalCta() {
  return (
    <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/65 md:text-lg">
          Discover how Huntlo is building Candidate Intelligence™ for the future of Human + AI
          Hiring.
        </p>
