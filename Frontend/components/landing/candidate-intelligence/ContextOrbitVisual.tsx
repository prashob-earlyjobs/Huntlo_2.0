...
import { HERO_FLOW } from "@/lib/candidateIntelligence";

type ContextOrbitVisualProps = {
  reduceMotion: boolean;
};

export function ContextOrbitVisual({ reduceMotion }: ContextOrbitVisualProps) {
