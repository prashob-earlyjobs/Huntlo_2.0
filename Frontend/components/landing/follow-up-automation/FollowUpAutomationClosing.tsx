...
export function FollowUpAutomationEnterprise() {
  return (
...
export function FollowUpAutomationFuture() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
            Hiring momentum is becoming infrastructure.
          </h2>
          <p className="mt-5 text-lg font-semibold text-[#141b2b] md:text-xl">
            Modern recruiting isn&apos;t becoming follow-up driven. It&apos;s becoming momentum
            driven.
          </p>
        </div>
...
export function FollowUpAutomationFaq() {
  return (
    <section className="bg-[#f7f8fc] px-4 py-20 md:px-8 md:py-28 lg:px-12" id="faqs">
      <div className="mx-auto max-w-3xl">
        ...
        <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
          Questions about Hiring Momentum Intelligence
        </h2>
        <p className="mt-4 text-base leading-relaxed text-[#434654] md:text-lg">
          Clear answers for teams moving from follow-up sequences to momentum-driven hiring.
        </p>

        <div className="mt-10 space-y-3">
          {FOLLOW_UP_AUTOMATION_FAQS.map((item) => (
            <details
              key={item.question}
...
export function FollowUpAutomationFinalCta() {
  return (
    <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        <h2 className="text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
          Great hiring maintains momentum.
        </h2>
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/65 md:text-lg">
          Discover how Huntlo is building Hiring Momentum Intelligence for the future of recruiting.
        </p>
        <div className="mt-9 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
          ...
          <Link href="#hiring-momentum" className={ghostCtaClass}>
            Meet Hiring Momentum
          </Link>
        </div>
      </div>
    </section>
