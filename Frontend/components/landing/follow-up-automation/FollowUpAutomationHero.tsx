...
import { MomentumSignalVisual } from "./MomentumSignalVisual";

type FollowUpAutomationHeroProps = {
  reduceMotion: boolean;
};

export function FollowUpAutomationHero({ reduceMotion }: FollowUpAutomationHeroProps) {
  return (
      ...
      <div className="relative mx-auto grid max-w-6xl gap-12 px-4 py-20 md:px-8 md:py-28 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-14 lg:px-12 lg:py-32">
        ...
        >
          ...
          <h1 className="mt-5 max-w-xl text-[2rem] font-bold leading-[1.12] tracking-tight sm:text-[2.35rem] md:text-[3rem] lg:text-[3.25rem]">
            Hiring doesn&apos;t break because of talent.
            <span className="mt-2 block text-white/75">It breaks because momentum is lost.</span>
          </h1>
          <p className="mt-6 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
            Great candidates don&apos;t disappear overnight. Hiring slows down when conversations
            stop, follow-ups are delayed, interviews are missed, and candidate experiences become
            fragmented.
          </p>
          <p className="mt-4 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
            The future of recruiting isn&apos;t becoming automation driven. It&apos;s becoming
            momentum driven.
          </p>
          <p className="mt-8 text-lg font-semibold tracking-tight md:text-xl">
            Welcome to Hiring Momentum Intelligence.
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <Link href="#hiring-momentum" className={primaryCtaClass}>
              Explore Hiring Momentum
            </Link>
        ...
        >
          <MomentumSignalVisual reduceMotion={reduceMotion} />
        </motion.div>
      </div>
    </section>
  );
