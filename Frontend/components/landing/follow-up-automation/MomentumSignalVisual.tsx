...
import { HERO_MOMENTUM_FLOW } from "@/lib/followUpAutomation";

type MomentumSignalVisualProps = {
  reduceMotion: boolean;
};

export function MomentumSignalVisual({ reduceMotion }: MomentumSignalVisualProps) {
  const steps = HERO_MOMENTUM_FLOW.slice(0, -1);
  const core = HERO_MOMENTUM_FLOW[HERO_MOMENTUM_FLOW.length - 1];
