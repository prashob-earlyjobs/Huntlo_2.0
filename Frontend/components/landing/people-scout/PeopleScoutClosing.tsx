...
export function PeopleScoutEnterprise() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
            Built for modern hiring teams at scale.
          </h2>
        </div>
...
export function PeopleScoutFuture() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
            The next generation of hiring won&apos;t be built around filters, databases, or Boolean
            searches.
          </p>
        </div>
        ...
        <p className="mt-10 text-xl font-semibold text-[#141b2b] md:text-2xl">
          ...
          <span className="mt-2 block text-[#0050cb]">
            Built for the future of Talent Discovery.
          </span>
        </p>
      </div>
    </section>
...
export function PeopleScoutFaq() {
  return (
    <section className="bg-[#f7f8fc] px-4 py-20 md:px-8 md:py-28 lg:px-12" id="faqs">
      <div className="mx-auto max-w-3xl">
        ...
        <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
          Questions about People Scout
        </h2>
        <p className="mt-4 text-base leading-relaxed text-[#434654] md:text-lg">
          Clear answers for teams evaluating Talent Discovery Intelligence — not another candidate
          database.
        </p>

        <div className="mt-10 space-y-3">
          {PEOPLE_SCOUT_FAQS.map((item) => (
            <details
              key={item.question}
...
export function PeopleScoutFinalCta() {
  return (
    <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        <h2 className="text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
          Great hiring begins with great talent discovery.
        </h2>
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/65 md:text-lg">
          Discover how People Scout is building AI-native Talent Discovery Intelligence for the
          future of Human + AI Hiring.
        </p>
        <div className="mt-9 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
          ...
          <Link href="#talent-discovery" className={ghostCtaClass}>
