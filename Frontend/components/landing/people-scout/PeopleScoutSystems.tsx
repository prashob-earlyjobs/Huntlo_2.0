...
type PeopleScoutSystemsProps = {
  reduceMotion: boolean;
};

export function PeopleScoutSystems({ reduceMotion }: PeopleScoutSystemsProps) {
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Talent discovery that ladders into outcomes.
            </h2>
          </div>
      ...
      <section className="bg-[#f1f3ff] px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Great talent discovery creates great hiring outcomes.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
              Future recruiting teams won&apos;t optimize sourcing workflows. They&apos;ll optimize
              hiring outcomes.
            </p>
          </div>
      ...
      <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
        <div
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_25%_15%,_rgba(0,80,203,0.28),_transparent_55%)]"
          aria-hidden
        />
        <div className="relative mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
              From search-and-wait to understanding-first discovery.
            </h2>
          </div>
          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-2" style={{ perspective: "1400px" }}>
            ...
            >
              ...
              <p className="mt-6 text-sm font-semibold text-[#8eb0ff]">
                The future belongs to Talent Discovery Intelligence.
              </p>
            </motion.div>
          </div>
        </div>
