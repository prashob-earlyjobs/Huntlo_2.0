...
type HiringWorkflowsSystemsProps = {
  reduceMotion: boolean;
};

export function HiringWorkflowsSystems({ reduceMotion }: HiringWorkflowsSystemsProps) {
  return (
    <>
      ...
      <section className="bg-[#f1f3ff] px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Workflow intelligence never stops learning.
            </h2>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
              AI amplifies hiring teams — not replaces them.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-white/65 md:text-lg">
              Modern recruiting shouldn&apos;t require recruiters to continuously manage follow-ups,
              experiences, coordination, transitions, and operational complexity.
            </p>
          </div>
          ...
          <div className="mt-8 flex flex-wrap gap-2">
            {RECRUITER_MANAGES.map((item) => (
              <span
                key={item}
                className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-white/55"
              >
                {item}
              </span>
            ))}
      ...
      <section className="border-b border-[#c3c6d6]/30 bg-white px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Hiring outcomes are the new workflow metrics.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
              The future belongs to intelligent hiring outcomes — not operational efficiency alone.
            </p>
          </div>
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border border-[#c3c6d6]/35 bg-[#f7f8fc] p-6">
              <h3 className="text-sm font-semibold uppercase tracking-[0.16em] text-[#434654]">
                Traditional recruiting measures
              </h3>
              <ul className="mt-4 space-y-2">
                {TRADITIONAL_METRICS.map((item) => (
                  <li
                    key={item}
            ...
            <div className="rounded-2xl border border-[#0050cb]/25 bg-[#0050cb]/8 p-6">
              <h3 className="text-sm font-semibold uppercase tracking-[0.16em] text-[#0050cb]">
                Modern hiring measures
              </h3>
              <ul className="mt-4 space-y-2">
                {MODERN_METRICS.map((item) => (
      ...
      <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#8eb0ff]">
              Future workflow stack
            </p>
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
              The future hiring workflow stack.
            </h2>
          </div>
      ...
      <section className="bg-[#f1f3ff] px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
              Future organizations won&apos;t ask which workflow automation software to buy.
              They&apos;ll ask how intelligently hiring can continuously move itself forward.
            </p>
          </div>
