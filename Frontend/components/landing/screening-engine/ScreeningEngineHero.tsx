...
import { ReadinessSignalVisual } from "./ReadinessSignalVisual";

type ScreeningEngineHeroProps = {
  reduceMotion: boolean;
};

export function ScreeningEngineHero({ reduceMotion }: ScreeningEngineHeroProps) {
  return (
      ...
      <div className="relative mx-auto grid max-w-6xl gap-14 px-4 py-20 md:px-8 md:py-28 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:gap-16 lg:px-12 lg:py-36">
        ...
        >
          ...
          <h1 className="mt-5 max-w-xl text-[2rem] font-bold leading-[1.1] tracking-tight sm:text-[2.45rem] md:text-[3.1rem] lg:text-[3.3rem]">
            Great hiring doesn&apos;t begin with screening.
            <span className="mt-2 block text-white/75">It begins with hiring confidence.</span>
          </h1>
          <p className="mt-6 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
            Modern organizations don&apos;t struggle because they lack candidate information. They
            struggle because making exceptional hiring decisions requires understanding far more
            than resumes, scores, and matching algorithms.
          </p>
          <p className="mt-4 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
            Great hiring continuously understands candidate context, hiring intent, conversation
          ...
          <p className="mt-8 text-lg font-semibold tracking-tight md:text-xl">
            Welcome to Hiring Confidence Intelligence™.
        ...
        >
          <ReadinessSignalVisual reduceMotion={reduceMotion} />
        </motion.div>
      </div>
    </section>
  );
