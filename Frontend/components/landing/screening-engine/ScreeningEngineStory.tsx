...
import {
  CONFIDENCE_UNDERSTANDS,
  FUTURE_UNDERSTANDS,
  TRADITIONAL_UNDERSTANDS,
} from "@/lib/screeningEngine";

type ScreeningEngineStoryProps = {
  reduceMotion: boolean;
};

export function ScreeningEngineStory({ reduceMotion }: ScreeningEngineStoryProps) {
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Great hiring requires great decisions.
            </h2>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
              Introducing Hiring Confidence Intelligence™
            </h2>
            <p className="mt-5 text-base leading-relaxed text-white/65 md:text-lg">
              Continuously understanding decisions — before recruiters ever make them.
            </p>
          </div>

          <ul className="mt-10 space-y-3">
            {CONFIDENCE_UNDERSTANDS.map((item, index) => (
              <motion.li
                key={item}
          ...
          <p className="mt-10 max-w-2xl text-base leading-relaxed text-white/70 md:text-lg">
            Future organizations won&apos;t ask which candidate scored highest. They&apos;ll ask
            which hiring decision creates the best business outcome.
          </p>
        </div>
      </section>
    </>
