...
export function ScreeningEngineEnterprise() {
  return (
...
export function ScreeningEngineFuture() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
            Great hiring doesn&apos;t optimize screening.
          </h2>
          <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
            It optimizes confidence. The organizations that define the next decade won&apos;t
            optimize resume screening, candidate matching, or ranking algorithms.
          </p>
        </div>
        ...
        <p className="mt-10 text-xl font-semibold text-[#141b2b] md:text-2xl">
          Welcome to the future of hiring confidence.
        </p>
      </div>
    </section>
  );
...
export function ScreeningEngineFaq() {
  return (
    <section className="bg-[#f7f8fc] px-4 py-20 md:px-8 md:py-28 lg:px-12" id="faqs">
      <div className="mx-auto max-w-3xl">
        ...
        <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
          Questions about Hiring Confidence Intelligence™
        </h2>
        <p className="mt-4 text-base leading-relaxed text-[#434654] md:text-lg">
          Clear answers for teams evaluating Hiring Confidence Intelligence™ — not another resume
          screening tool.
        </p>

        <div className="mt-10 space-y-3">
          {SCREENING_ENGINE_FAQS.map((item) => (
            <details
              key={item.question}
...
export function ScreeningEngineFinalCta() {
  return (
    <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        <h2 className="text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
          Great hiring begins with confidence.
        </h2>
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/65 md:text-lg">
          Discover how Huntlo is building Hiring Confidence Intelligence™ for the future of Human +
          AI Hiring.
        </p>
        <div className="mt-9 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
          <BookDemoLink className={primaryCtaClass}>Book Enterprise Demo</BookDemoLink>
          <Link href="#hiring-confidence" className={secondaryCtaClass}>
