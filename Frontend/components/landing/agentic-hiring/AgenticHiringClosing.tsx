...
import { AGENTIC_HIRING_FAQS } from "@/lib/agenticHiring";
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-base leading-relaxed text-white/65 md:text-lg">
            Designed for organizations that need Human + AI recruiting with operational control.
          </p>
        </div>
    ...
    <section className="bg-white px-4 py-20 md:px-8 md:py-28 lg:px-12" id="faqs">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-4 text-base leading-relaxed text-[#434654] md:text-lg">
          Clear answers for leaders evaluating Human + AI recruiting — without the replacement
          narrative.
        </p>
    ...
    <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        <h2 className="text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.75rem]">
          ...
          <span className="mt-2 block text-white/70">It&apos;s changing what&apos;s possible.</span>
        </h2>
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/65 md:text-lg">
          Discover how Huntlo is building the future of Human + AI Recruiting through Agentic
          Hiring.
        </p>
        <div className="mt-9 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
          ...
          <Link href="/hiring-os" className={ghostCtaClass}>
