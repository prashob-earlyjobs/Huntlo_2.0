...
import { ConversationAgentVisual } from "./ConversationAgentVisual";
import { ghostCtaClass, primaryCtaClass, secondaryCtaClass } from "./ctaClasses";

type AiOutreachAgentHeroProps = {
  reduceMotion: boolean;
};

export function AiOutreachAgentHero({ reduceMotion }: AiOutreachAgentHeroProps) {
  return (
      ...
      <div className="relative mx-auto grid max-w-6xl gap-12 px-4 py-20 md:px-8 md:py-28 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-14 lg:px-12 lg:py-32">
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#8eb0ff]">
            Candidate Conversation Intelligence
          </p>
          <h1 className="mt-5 max-w-xl text-[2rem] font-bold leading-[1.12] tracking-tight sm:text-[2.35rem] md:text-[3rem] lg:text-[3.25rem]">
            Great candidates don&apos;t respond to automation.
            <span className="mt-2 block text-white/75">
              They respond to meaningful conversations.
            </span>
          </h1>
          <p className="mt-6 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
            Modern recruiting teams don&apos;t struggle because candidates aren&apos;t receiving
            enough messages. They struggle because candidate conversations often begin without
            context, timing, or relevance.
          </p>
          <p className="mt-4 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
            The future of recruiting isn&apos;t becoming outreach driven. It&apos;s becoming
            conversation driven.
          </p>
          <p className="mt-8 text-lg font-semibold tracking-tight md:text-xl">
            Welcome to Candidate Conversation Intelligence.
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <Link href="#conversation-intelligence" className={primaryCtaClass}>
        ...
        >
          <ConversationAgentVisual reduceMotion={reduceMotion} />
        </motion.div>
      </div>
    </section>
  );
