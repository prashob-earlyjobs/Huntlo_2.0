...
export function InterviewOrchestrationEnterprise() {
  return (
...
export function InterviewOrchestrationFuture() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
            Great interviews don&apos;t optimize processes.
          </h2>
          <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
            They optimize hiring decisions. The organizations that define the next decade won&apos;t
            optimize interview scheduling, interview workflows, or feedback collection.
          </p>
        </div>
        ...
        <p className="mt-10 text-xl font-semibold text-[#141b2b] md:text-2xl">
          Welcome To The Future Of Interview Intelligence.
        </p>
      </div>
    </section>
  );
...
export function InterviewOrchestrationFaq() {
  return (
    <section className="bg-[#f7f8fc] px-4 py-20 md:px-8 md:py-28 lg:px-12" id="faqs">
      <div className="mx-auto max-w-3xl">
        ...
        <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
          Questions about Interview Intelligence™
        </h2>
        <p className="mt-4 text-base leading-relaxed text-[#434654] md:text-lg">
          Clear answers for teams evaluating Interview Intelligence™ — not another interview
          scheduling or management platform.
        </p>

        <div className="mt-10 space-y-3">
          {INTERVIEW_ORCHESTRATION_FAQS.map((item) => (
            <details
              key={item.question}
...
export function InterviewOrchestrationFinalCta() {
  return (
    <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        <h2 className="text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
          Great Hiring Begins With Great Decisions.
        </h2>
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/65 md:text-lg">
          Discover how Huntlo is building Interview Intelligence™ for the future of Human + AI
          Hiring.
        </p>
