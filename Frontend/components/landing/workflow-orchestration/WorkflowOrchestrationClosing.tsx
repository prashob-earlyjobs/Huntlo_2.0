    ...
    <>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Recruiters shouldn&apos;t coordinate workflows. They should coordinate talent.
            </h2>
          </div>

          <div className="mt-10 grid gap-6 md:grid-cols-3">
            <div className="rounded-3xl border border-[#0050cb]/20 bg-[#f1f3ff] p-6 md:p-8 md:col-span-1">
      ...
      <section className="bg-[#f1f3ff] px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#0050cb]">
              Future of workflow intelligence
            </p>
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              We believe modern hiring teams won&apos;t purchase workflow automation.
            </h2>
            <p className="mt-5 text-lg font-semibold text-[#141b2b] md:text-xl">
              They&apos;ll adopt workflow intelligence.
            </p>
          </div>

          <div className="mt-10 flex flex-wrap items-center gap-2 md:gap-3">
            {FUTURE_INTELLIGENCE.map((item, index) => (
              <div key={item} className="flex items-center gap-2 md:gap-3">
                ...
                {index < FUTURE_INTELLIGENCE.length - 1 ? (
      ...
      <section className="bg-[#070d1a] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-14 max-w-3xl border-t border-white/10 pt-10">
            <h2 className="text-[1.5rem] font-bold tracking-tight md:text-[2rem]">
              The future isn&apos;t automation. It&apos;s orchestration.
            </h2>
            <p className="mt-4 text-base leading-relaxed text-white/65 md:text-lg">
              AI shouldn&apos;t simply automate hiring. It should intelligently orchestrate people,
              workflows, intelligence, priorities, and outcomes.
            </p>
            <p className="mt-4 text-lg font-semibold text-white">
              The future of hiring belongs to intelligent workflow orchestration.
            </p>
          </div>
        </div>
      </section>
    ...
    <section className="bg-white px-4 py-20 md:px-8 md:py-28 lg:px-12" id="faqs">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-4 text-base leading-relaxed text-[#434654] md:text-lg">
          Clear answers for leaders moving from task automation to intelligent hiring
          orchestration.
        </p>
    ...
    <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        <h2 className="text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.75rem]">
          Hiring doesn&apos;t need more automation.
          <span className="mt-2 block text-white/70">It needs better orchestration.</span>
        </h2>
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/65 md:text-lg">
          Discover how Huntlo is building intelligent workflow orchestration for the future of
          hiring.
        </p>
        <div className="mt-9 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
          ...
          <Link href="#workflow-intelligence" className={ghostCtaClass}>
