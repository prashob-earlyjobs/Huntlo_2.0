...
type MarketingPageShellProps = {
  ...
  /** Rendered below the primary content column (e.g. FAQ). */
  afterContent?: React.ReactNode;
  /** Page-specific GEO prompt for footer AI platform deep links. */
  aiAskPrompt?: string;
  /** e.g. "booking a Huntlo AI demo" for link titles. */
  aiAskTopic?: string;
};
...
export function MarketingPageShell({
  ...
  return (
    <div className="landing-page selection:bg-[#0050cb] selection:text-[#c1cfff]">
      ...
      <LandingFooter aiAskPrompt={aiAskPrompt} aiAskTopic={aiAskTopic} />
    </div>
  );
}
