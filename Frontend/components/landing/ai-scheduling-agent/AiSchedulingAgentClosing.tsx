...
export function AiSchedulingAgentEnterprise() {
  return (
...
export function AiSchedulingAgentFuture() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
            Modern recruiting isn&apos;t becoming workflow driven.
          </h2>
...
export function AiSchedulingAgentFaq() {
  return (
    <section className="bg-[#f7f8fc] px-4 py-20 md:px-8 md:py-28 lg:px-12" id="faqs">
      <div className="mx-auto max-w-3xl">
        ...
        <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
          Questions about AI Workflow Intelligence
        </h2>
        <p className="mt-4 text-base leading-relaxed text-[#434654] md:text-lg">
          Clear answers for teams moving from scheduling tools to intelligence-driven Agentic Hiring.
        </p>

        <div className="mt-10 space-y-3">
          {AI_SCHEDULING_AGENT_FAQS.map((item) => (
            <details
              key={item.question}
...
export function AiSchedulingAgentFinalCta() {
  return (
    <section className="relative overflow-hidden bg-[#050914] px-4 py-20 text-white md:px-8 md:py-28 lg:px-12">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/65 md:text-lg">
          Discover how Huntlo is building AI Workflow Intelligence for the future of Human + AI
          Hiring.
        </p>
