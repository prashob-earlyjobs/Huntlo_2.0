...
type AiSchedulingAgentSystemsProps = {
  reduceMotion: boolean;
};

export function AiSchedulingAgentSystems({ reduceMotion }: AiSchedulingAgentSystemsProps) {
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#0050cb]">
              Velocity from intelligence
            </p>
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.5rem]">
              Workflow intelligence creates hiring velocity.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
              Future recruiting teams won&apos;t optimize hiring workflows. They&apos;ll optimize
              hiring outcomes.
            </p>
          </div>

          <ul className="mt-8 grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
            {WORKFLOW_IMPROVES.map((item) => (
              <li
                key={item}
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight md:text-[2.5rem]">
              AI Scheduling Agents never stop learning.
            </h2>
      ...
      <section className="bg-[#f1f3ff] px-4 py-20 md:px-8 md:py-28 lg:px-12">
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <h2 className="mt-4 text-[1.75rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[2.35rem]">
              Hiring experiences should feel effortless.
            </h2>
            <p className="mt-5 text-base leading-relaxed text-[#434654] md:text-lg">
              Future enterprises won&apos;t optimize operational efficiency alone. They&apos;ll
              optimize intelligent hiring experiences.
            </p>
          </div>
        ...
        <div className="mx-auto mt-14 max-w-6xl rounded-3xl border border-[#c3c6d6]/35 bg-white p-6 md:p-8">
          ...
          <h2 className="mt-4 text-[1.5rem] font-bold leading-tight tracking-tight text-[#141b2b] md:text-[1.85rem]">
            Workflow intelligence is becoming infrastructure.
          </h2>
          <p className="mt-4 text-base leading-relaxed text-[#434654]">
            Modern organizations won&apos;t ask which scheduling software to use. They&apos;ll ask
            how hiring can intelligently move itself forward.
          </p>
