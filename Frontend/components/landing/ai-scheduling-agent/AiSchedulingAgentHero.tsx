...
import { WorkflowSignalVisual } from "./WorkflowSignalVisual";

type AiSchedulingAgentHeroProps = {
  reduceMotion: boolean;
};

export function AiSchedulingAgentHero({ reduceMotion }: AiSchedulingAgentHeroProps) {
  return (
      ...
      <div className="relative mx-auto grid max-w-6xl gap-12 px-4 py-20 md:px-8 md:py-28 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-14 lg:px-12 lg:py-32">
        ...
        >
          ...
          <h1 className="mt-5 max-w-xl text-[2rem] font-bold leading-[1.12] tracking-tight sm:text-[2.35rem] md:text-[3rem] lg:text-[3.25rem]">
            Hiring should never wait for workflows.
            <span className="mt-2 block text-white/75">
              Workflows should move hiring forward automatically.
            </span>
          </h1>
          <p className="mt-6 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
            Modern hiring isn&apos;t slowed down because organizations cannot schedule interviews.
            It&apos;s slowed down because hiring workflows become fragmented across conversations,
            decisions, interviews, and candidate experiences.
          </p>
          <p className="mt-4 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
            Great hiring shouldn&apos;t feel operational. It should feel intelligent.
          </p>
          <p className="mt-8 text-lg font-semibold tracking-tight md:text-xl">
            Welcome to AI Workflow Intelligence.
        ...
        >
          <WorkflowSignalVisual reduceMotion={reduceMotion} />
        </motion.div>
      </div>
    </section>
  );
