...
const nodes = ["Profile", "Experience", "Skills", "Email", "Phone", "Location"];
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <p className="text-lg text-slate-500 leading-relaxed max-w-md">
            When you already know who you want to reach, People Scout gives you a fast path from
            profile URL to qualified outreach.
          </p>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center py-12">
          <div className="relative w-[340px] h-[340px] md:w-[400px] md:h-[400px]">
            ...
            >
              <span className="text-white font-bold text-sm leading-tight px-4">Enriched Profile</span>
            </motion.div>
            {nodes.map((node, i) => {
