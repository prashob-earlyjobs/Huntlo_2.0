      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">
            Built For Objective Skill Evaluation
          </h2>
        </div>
          ...
          <div className="flex h-[500px] md:h-[600px] bg-[#0B1120]">
            <div className="w-16 md:w-64 border-r border-slate-800 flex flex-col p-4">
              ...
              <div className="space-y-2 flex-1">
                {[
                  ...
                  { icon: ClipboardCheck, label: "Assessments", active: true },
            ...
            <div className="flex-1 flex flex-col min-w-0">
              <header className="h-16 border-b border-slate-800 flex items-center justify-between px-6">
                <h2 className="font-semibold hidden sm:block">Assessments</h2>
                  ...
                  {[
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-semibold text-blue-400">{row.score}</span>
                      </div>
                    </motion.div>
                  ))}
                </div>
