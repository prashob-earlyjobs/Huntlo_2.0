      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="pt-2">
            <h3 className="text-xl font-semibold text-slate-800 mb-3">
              Stop guessing about candidate skills.
            </h3>
            <p className="text-lg text-slate-500 leading-relaxed max-w-md">
              Standardize skill evaluations, automate scoring, and give hiring teams objective data
        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center py-12">
          <div className="relative w-[340px] h-[340px] md:w-[400px] md:h-[400px]">
            ...
            >
              <span className="text-white font-bold text-sm leading-tight px-4">Skill Score</span>
            </motion.div>
