...
const steps = [
  {
    number: "01",
    title: "Engage",
    description: "Reach candidates through outreach workflows.",
  },
  {
    number: "02",
    title: "Screen",
    description: "Run AI-powered qualification checks.",
  },
  {
    number: "03",
    title: "Qualify",
    description: "Surface candidates who meet role criteria.",
  },
  {
    number: "04",
    title: "Advance",
    description: "Move qualified talent to the next stage.",
  },
];
    ...
    <section className="py-32 px-6 max-w-7xl mx-auto">
      <div className="mb-20 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">
          From First Response To Qualified Pipeline
        </h2>
      </div>
