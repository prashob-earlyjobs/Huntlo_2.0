...
import { BarChart3, ClipboardList, Mic, ShieldCheck } from "lucide-react";
import { motion } from "motion/react";

const cards = [
  {
    title: "Screening Queue",
    description: "Track candidates awaiting qualification.",
    icon: ClipboardList,
  },
  {
    title: "Match Scores",
    description: "See how candidates align with role criteria.",
    icon: BarChart3,
  },
  {
    title: "Voice Responses",
    description: "Review AI screening conversation outcomes.",
    icon: Mic,
  },
  {
    title: "Qualification Status",
    description: "Advance or pass with confidence.",
    icon: ShieldCheck,
  },
];
    ...
    <section className="py-24 px-6 max-w-7xl mx-auto">
      <div className="mb-16 text-center md:text-left">
        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight max-w-2xl">
          Everything Connected In One Screening Workflow
        </h2>
      </div>
