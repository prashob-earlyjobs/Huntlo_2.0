...
export const FILTER_SECTIONS: FilterSection[] = [
    ...
    fields: [
      {
        ...
        label: "Current title",
        type: "multi",
        autocompleteFilterType: "current_employers.title",
      ...
      },
      {
        ...
        type: "multi",
        autocompleteFilterType: "past_employers.title",
        options: TITLE_OPTIONS,
        placeholder: "Search titles…",
      },
    ],
  },
  {
    ...
    fields: [
      ...
      //   type: "multi",
      //   autocompleteFilterType: "current_employers.function_category",
      ...
      //   label: "Seniority",
      //   type: "multi",
      //   autocompleteFilterType: "current_employers.seniority_level",
