...
import { Briefcase, CalendarClock, Layers } from "lucide-react";
...
export const JOB_METRICS: JobMetric[] = [
  ...
  },
  {
    ...
    trend: "up",
    comparison: "vs last month",
    tooltip: "Sum of headcount openings across active jobs.",
    icon: Briefcase,
  },
  {
    id: "interviews-week",
    ...
    tooltip: "Interviews scheduled across all jobs for the current week.",
    icon: CalendarClock,
  },
];
...
export const JOB_FORM_SECTIONS = [
  { id: "basic", title: "Role details", description: "Role identity and location" },
