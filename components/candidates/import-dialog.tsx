...
function UploadStep({
  ...
  return (
    <div className="space-y-3">
      <label
        htmlFor="import-file"
        className="flex cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-border bg-muted/30 px-6 py-10 text-center transition-colors hover:bg-muted/50"
      >
...
function SummaryStep() {
  return (
    <div className="space-y-3 text-center">
      ...
      <dl className="mx-auto grid max-w-sm grid-cols-2 gap-2 text-left text-sm">
