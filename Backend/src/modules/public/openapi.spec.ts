  ...
  paths: {
    ...
    '/candidates/search/apply': {
      post: {
        ...
        description:
          'Converts prompt + drawer filters to natural language, calls Future Jobs POST /wl/search with optional structured YoE, country, and city filters, and waits for the response (no poll). Consumes one candidate_search quota. sessionId = Future Jobs id; savedSessionId = Mongo id.',
        responses: {
          '200': {
