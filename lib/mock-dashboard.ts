...
export const OVERVIEW_METRICS: OverviewMetric[] = [
  ...
  },
  {
    ...
    trend: "up",
    comparison: "vs last month",
    tooltip: "Candidates who received at least one outreach message this calendar month.",
    icon: Send,
  },
  {
    id: "interested",
  ...
  },
  {
    ...
    trend: "down",
    comparison: "vs last month",
    tooltip: "AI voice screenings completed across all screening batches.",
    icon: AudioLines,
  },
  {
    id: "interviews",
...
/** Ordered funnel stages. Conversion and drop-off are derived per stage. */
export const PIPELINE_STAGES: PipelineStage[] = [
  { id: "sourced", label: "Sourced", count: 2486 },
  { id: "revealed", label: "Revealed", count: 1732 },
  ...
  { id: "interview", label: "Interview Scheduled", count: 29 },
];
...
export interface PriorityItem {
  ...
  /** Module the item belongs to, shown as context. */
  module: string;
  href: AppRoute;
  actionLabel: string;
  time: string;
...
export const TODAY_PRIORITIES: PriorityItem[] = [
  {
    id: "p1",
    title: "12 high-intent candidates awaiting review",
    priority: "High",
  ...
  {
    id: "p2",
    title: "8 candidate replies requiring recruiter action",
    priority: "High",
  ...
  {
    id: "p3",
    title: "Gmail integration needs reconnection",
    priority: "High",
    module: "Integrations",
  ...
  {
    id: "p4",
    title: "4 screenings completed and ready for review",
    priority: "Medium",
    module: "AI Screening",
  ...
  {
    id: "p6",
    title: "Mobile reveal quota has reached 82%",
    priority: "Low",
    module: "Plans & Usage",
    href: ROUTES.plans,
...
/** Compact plan usage bars for the home dashboard. */
export const DASHBOARD_USAGE: CreditMetric[] = CREDIT_METRICS.map((metric) => {
  const labels: Record<string, string> = {
    searches: "Candidate searches",
    "email-reveals": "Email reveals",
    "mobile-reveals": "Mobile reveals",
    "email-outreach": "Email outreach",
    whatsapp: "WhatsApp outreach",
    voice: "AI voice minutes",
  };
  return { ...metric, label: labels[metric.id] ?? metric.label };
});
