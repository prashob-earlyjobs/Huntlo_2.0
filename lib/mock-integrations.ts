...
export const INTEGRATION_PROVIDERS: IntegrationProvider[] = [
  ...
  /* WhatsApp */
  {
    ...
    category: "WhatsApp",
    status: "Connected",
    connectedIdentity: "+91 98765 43210",
    lastSynced: "4m ago",
    ...
    usage: [
      { label: "Templates approved", value: "12" },
      { label: "Messages today", value: "86" },
    ],
    connectionDetails: [
      { label: "WABA ID", value: "1098••••4521" },
      { label: "Phone number ID", value: "2156••••8830" },
