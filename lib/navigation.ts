    ...
    items: [
      {
        ...
        href: ROUTES.search,
        icon: Search,
        description: "Search candidates with natural language",
      },
      {
      ...
      },
      {
        ...
        icon: UserSearch,
        description: "Continuous agentic candidate discovery",
        featureLabel: "Beta",
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: AudioLines,
        description: "Screen candidates with AI voice agents",
      },
      {
