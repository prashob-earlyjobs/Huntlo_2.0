...
export const USAGE_QUOTAS: UsageQuota[] = [
  {
    ...
    description: "AI candidate searches across the talent graph",
    used: 2580,
    limit: 10_000,
  ...
  },
  {
    id: "email-reveals",
    label: "Email reveals",
    description: "Unlock candidate email addresses from search results",
    used: 640,
    limit: 2_500,
    resetDate: "1 Aug 2026",
    icon: Mail,
  },
  {
    ...
    description: "Unlock candidate phone numbers for WhatsApp and voice",
    used: 1060,
    limit: 2_000,
    resetDate: "1 Aug 2026",
    icon: Smartphone,
